export function formatArticle(article, source) {
    ...
    let formattedArticle = {
        ...
        abstract: article.abstract || article.description || article.fields?.trailText || 'No Abstract Available',
        ...
        pub_date: formatDate(article.pub_date || article.webPublicationDate || article.publishedAt || 'Unknown Date'), 
